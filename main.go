...
import (
	...
	"github.com/lnnujxxy/go-gin-example/models"
...
// @termsOfService https://github.com/lnnujxxy/go-gin-example
// @license.name MIT
// @license.url https://github.com/lnnujxxy/go-gin-example/blob/master/LICENSE
func main() {
